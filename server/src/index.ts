...
import { getUsersLeaderboard } from './controllers/getUsersLeaderboard';
import { addUser } from './controllers/addUser';
import { getUsers } from './controllers/getUsers';
import { addScores } from './controllers/addScores';
import { getUser } from './controllers/getUser';
import { getScores } from './controllers/getScores';
...
function setupRoutes() {
  ...
  app.get('/scores/:userID', getScore); // all scores for that user
  app.post('/scores', addScores); // all scores in DB
